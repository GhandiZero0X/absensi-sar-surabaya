...
($(document).ready(function () {
  ...
  $(document).ready(function () {
    var e = document.getElementById("taskDateRange"),
      t = document.getElementById("taskDateRangeAdd");
    (new DateRangePicker(e, { clearBtn: !0, allowOneSidedRange: !0 }),
      new DateRangePicker(t, { clearBtn: !0, allowOneSidedRange: !0 }));
  }),
  $(document).ready(function () {
