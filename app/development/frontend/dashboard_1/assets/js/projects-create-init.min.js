...
($(document).ready(function () {
  ($("#project-type").validate(),
    ...
    $("#project-create-steps").steps({
      ...
      onStepChanging: function (e, t, n) {
        return (
          ...
          ((n.validate().settings.ignore = ":disabled,:hidden"), n.valid())
        );
      },
      onFinishing: function (e, t) {
        ...
        return (
          1 != n.length ||
          ((n.validate().settings.ignore = ":disabled"), n.valid())
        );
      },
    ...
    $(
      "#billingType, #projectStatus, #projectTags, #tragetTags, [data-select2-teammates='teammates']",
    ).select2({
      theme: "bootstrap-5",
